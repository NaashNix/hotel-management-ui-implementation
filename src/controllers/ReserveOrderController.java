...
public class ReserveOrderController {
    ...
    public AnchorPane ReserveOrderContext;
    public JFXButton btnreserveOrderOK;
    public Rectangle GuestDetailsSQ;
    public Label txtGuestDetails;
    // -------- HERE GOES ATTRIBUTES ------------

    // --------- HERE GOES METHODS FOR BOTTOM MENU ITEMS
    ...
    //FUNCTIONS
    public void navigateToCheckout(ActionEvent actionEvent) throws IOException {
        URL resource = getClass().getResource("../view/receptionistView/CheckOutForm.fxml");
        Parent load = FXMLLoader.load(resource);
        Stage window = (Stage) ReserveOrderContext.getScene().getWindow();
